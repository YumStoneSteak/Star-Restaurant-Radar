...
1. GitHub Releases에서 `StarRestaurantRadar-Setup-v1.1.0.exe`를 다운로드합니다.
2. 다운로드한 설치 파일을 실행합니다.
3. 설치가 끝나면 설정 화면이 한 번 자동으로 열립니다.
4. 알림 시간을 확인하거나 원하는 시간으로 바꾼 뒤 창을 닫으면 됩니다.
...
- `dist\StarRestaurantRadar-Setup-v1.1.0.exe`
- `dist\StarRestaurantRadar-Setup-v1.1.0.exe.sha256`
